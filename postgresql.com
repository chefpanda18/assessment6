...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-10-17T18:00:19.830983" />
  ...
  <link href="/media/css/fontawesome.css?8b0cb451" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?8b0cb451">
  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row justify-content-center pg-shout-box">
        <div class="col text-white text-center">30th September 2021: <a href="https://www.postgresql.org/about/news/postgresql-14-released-2318/">
    ...
    <div class="col-lg-6 feature">
      ...
      <div class="text">
        ...
        <ul>
            ...
            <li class=""><strong>14.0</strong> &middot; 2021-09-30 &middot; <a href="/docs/14/release-14.html">Notes</a></li>
          
            <li class="pg-bg-gray"><strong>13.4</strong> &middot; 2021-08-12 &middot; <a href="/docs/13/release-13-4.html">Notes</a></li>
          
            <li class=""><strong>12.8</strong> &middot; 2021-08-12 &middot; <a href="/docs/12/release-12-8.html">Notes</a></li>
          
            <li class="pg-bg-gray"><strong>11.13</strong> &middot; 2021-08-12 &middot; <a href="/docs/11/release-11-13.html">Notes</a></li>
          
            <li class=""><strong>10.18</strong> &middot; 2021-08-12 &middot; <a href="/docs/10/release-10-18.html">Notes</a></li>
          
            <li class="pg-bg-gray"><strong>9.6.23</strong> &middot; 2021-08-12 &middot; <a href="/docs/9.6/release-9-6-23.html">Notes</a></li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/psycopg-30-released-2328/">Psycopg 3.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-10-13 by Psycopg Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgconf-nyc-2021-sessions-announced-last-week-for-early-bird-2327/">PGConf NYC 2021 Sessions Announced, Last Week for Early Bird!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-10-13 by United States PostgreSQL Association</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_partman-460-released-2326/">pg_partman 4.6.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-10-13 by Crunchy Data</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-october-10-2021-2325/">PostgreSQL Weekly News - October 10, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-10-11 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v60-released-2323/">pgAdmin 4 v6.0 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-10-11 by pgAdmin Development Team</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bM"> Backup Label in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Z</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-10-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bL"> Using Query ID in Postgres 14</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bK"> Multi-Cluster Postgres Federation on Kubernetes with Postgres 14 Using GitOps</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jonathan Katz</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-10-14</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bI"> Kafka Connect and Elasticsearch vs. PostgreSQL Pipelines: Initial Performance Results </a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paul Brebner</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-10-13</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bH"> SHOW TABLES in PostgreSQL: what’s wrong with it?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bG"> pspg 5.4.1 released</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bF"> Why Linux HugePages are Super Important for Database Servers: A Case with PostgreSQ</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jobin Augustine</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-10-12</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bE"> Orafce 3.16.2 for Postgres 12, 13 and 14 for Microsoft Windows</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavel Stehule</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-10-12</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5bC"> Multirange types in PostgreSQL 14</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?8b0cb451"></script>
